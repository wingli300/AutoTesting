...
public class ZTestReport implements IReporter {
	...
	private String path = System.getProperty("user.dir") + File.separator +"ztest-master"+ File.separator+"report.html";

	private String templatePath = System.getProperty("user.dir") + File.separator +"ztest-master"+ File.separator + "template";
